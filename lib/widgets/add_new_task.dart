...
import 'package:to_do_list/providers/firestore_database.dart';
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Bet amount', style: Theme.of(context).textTheme.subtitle),
            TextFormField(
              keyboardType: TextInputType.number,
              decoration: InputDecoration(
                hintText: '0.0\$',
              ),
              initialValue: _inputBet == null ? null : _inputBet,
              validator: (value) {
                if (value.isEmpty) {
